...
class threadRepliesCV: UICollectionViewController {
                        ...
                        if self.replyCount != 0{
                            ...
                            for i in 0...forLimit{
                                ...
                                if self.replyCount == self.threadReplies.count{
                                    print(">1🏁🏁🏁🏁🏁🏁🏁")
                                    //self.threadReplyCVOutlet.reloadData()
    ...
    @objc func completeThread(){
        ...
        //navBarButtons
        let refreshButton = UIBarButtonItem(image: UIImage(named: "refreshWVx50"), style: .plain, target: self, action: #selector(threadRepliesCV.refresh))
        let goDown = UIBarButtonItem(image: UIImage(named: "downx50"), style: .plain, target: self, action: #selector(threadRepliesCV.down))
        navigationItem.rightBarButtonItems = [refreshButton, goDown]
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        print("📌threadReplies: \(threadReplies.count)")
